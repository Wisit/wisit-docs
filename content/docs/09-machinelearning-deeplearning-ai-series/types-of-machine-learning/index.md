...
เป้าหมายสูงสุดคือการฝึกให้สมองกลค้นหาและเรียนรู้ฟังก์ชันคาดเดา {{< katex >}}$h(\mathbf{x})${{< /katex >}} เพื่อแมปคุณลักษณะต้นทางไปหาป้ายเฉลยได้อย่างมีประสิทธิภาพสูงสุด โดยค่าความคลาดเคลื่อนจะถูกประเมินผ่านฟังก์ชันสูญเสีย (Loss Function) และอัปเดตโมเดลย้อนกลับเพื่อปรับปรุงคะแนน
...
เป้าหมายสูงสุดของ Agent คือการเรียนรู้เพื่อหาทิศทางนโยบายการตัดสินใจ (Policy {{< katex >}}$\pi${{< /katex >}}) ที่สร้างผลรวมคะแนนรางวัลสะสมในระยะยาวสูงสุด (Expected Cumulative Reward)
